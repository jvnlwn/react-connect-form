    ...
    return _temp2 = _class = function (_Component) {
      ...
      _createClass(_class, [{
        ...
        value: function componentWillReceiveProps(nextProps, nextState) {
          ...
          } else if (!(0, _utils.isEqual)(nextProps.initialValue, this.props.initialValue)) {
        ...
        value: function render() {
          ...
          var nested = !!this.context._formState;

          var _getChildContext = this.getChildContext(),
              _formState = _getChildContext._formState;

          return _react2.default.createElement(ComposedComponent, _extends({}, passProps, _formState, { nested: nested }));
        }
      }, {
        key: "pristine",
        get: function get() {
      ...
      onPristine: _propTypes2.default.func,
      ...
      _formState: _propTypes2.default.object
